"""
AI Mentor — calls Groq's chat completions API (OpenAI-compatible format).
See spec §17-18 for the behavioral contract this system prompt encodes:
hints before answers, never claim tests passed without real results,
distinguish syntax from architectural mistakes, adapt to the learner's
actual code and history.
