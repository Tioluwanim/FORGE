...
export default function SelectLanguagePage() {
  ...
  function handleContinue() {
    if (!selected) return;
    // Passed to /onboarding, which creates the Track once we also know the
    // skill level — see that page's handling of this same key.
    sessionStorage.setItem("forge_selected_language", selected);
